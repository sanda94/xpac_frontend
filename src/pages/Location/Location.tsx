...
const Location:React.FC = () => {
    ...
    const HandleSubmit = () => {
        if(!location.location){
            notify('Add location before click save button' , 'info');
            return;
          }
          ...
          Swal.fire({
            title: "",
            text: "Are you sure you want to Create New Location?",
            icon: "question",
      ...
      {isFormOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-5 bg-black bg-opacity-50">
          <div className="w-full p-8 bg-white rounded-lg lg:w-2/3">
            <h2 className="mb-4 text-lg font-bold text-center text-black">Add New Location</h2>
