...
const Home: React.FC = () => {
  ...
  return (
    <div style={{ color: colors.grey[100] }}>
      ...
      <div className="grid gap-5 lg:grid-rows-10 grid-cols-1 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 auto-rows-[minmax(180px, auto)] mt-5">
        {/* Totle Customers */}
        ...
        <div className="flex flex-col items-center justify-between col-span-1 row-span-6 p-5 rounded-lg lg:col-span-2 md:col-span-2 box">
          <span 
              ...
              style={{ color: colors.grey[100] }}
              >Recent Device with Items Count and Battery Percentage</span>
            <Barchart />
        </div>
      </div>
    </div>
