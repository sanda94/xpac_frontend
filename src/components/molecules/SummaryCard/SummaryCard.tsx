...
const SummaryCard: React.FC<SummaryCardProps> = ({
  ...
  return (
    <div
      ...
      className={`p-6 rounded-lg z-30 md:max-w-[480px] lg:max-w-[480px] sm:max-w-[95%] md:h-[450px] relative md:min-h-[450px] md:max-h-[500px] w-full overflow-hidden 
    ...
    >
      ...
      <div className="grid gap-4 mt-4 cursor-default md:grid-cols-2">
        <div className="col-span-1">
          <p>
            ...
            >
              Critical Level:{" "}
              <span className="font-normal">{minCount ? minCount : 0}</span>
            </span>
          </p>
          {/* <p>
            <span 
      ...
      <div className="mb-5 cursor-default lg:mb-2">
        ...
        <p
          className="overflow-hidden line-clamp-2 text-ellipsis md:min-w-[370px] lg:min-w-[370px] md:max-w-[375px] lg:max-w-[375px] sm:max-w-[90%] sm:min-w-[85%]"
          style={{
            display: "-webkit-box",
      ...
      <div className="mb-5 cursor-default lg:mb-2">
        <p
          className="md:max-w-[375px] md:min-w-[370px] lg:min-w-[370px] line-clamp-2 text-ellipsis overflow-hidden lg:max-w-[375px] sm:max-w-[90%] sm:min-w-[85%]"
      ...
      <div className="absolute flex items-center gap-2 cursor-default bottom-2 right-6">
        <span className="text-4xl">
          {batteryPercentage === 0 ? (
            <TbBattery />
          ) : batteryPercentage > 0 && batteryPercentage <= 40 ? (
            <TbBattery1 />
          ) : batteryPercentage > 40 && batteryPercentage <= 60 ? (
            <TbBattery2 />
          ) : batteryPercentage > 60 && batteryPercentage <= 80 ? (
            <TbBattery3 />
          ) : batteryPercentage > 80 && batteryPercentage <= 1000 ? (
            <TbBattery4 />
          ) : null}
        </span>
        <span
